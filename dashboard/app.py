...
def load_measurements():
    """Lädt alle Messdaten"""
    # Prüfe ob zusammengefasste Datei existiert
...
def load_docsis_history():
    """Lädt DOCSIS-Historie falls vorhanden"""
...
def main():
    ...
    if df.empty:
        ...
        Stelle sicher, dass das `/data` Verzeichnis die CSV-Dateien enthält.
        """)
        return
